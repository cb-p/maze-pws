from maze import *
from generators.mountain import *
from queue import PriorityQueue


class DijkstrasSolver(MazeSolver):
    def __init__(self, maze, start, end):
        ...
        self.steps = [[0] * maze.maze_height for _ in range(maze.maze_width)]
        self.path = [self.end]
            ...
            if len(directions) != 0:
                for direction in directions:
                    ...
                    if new_pos:
                        ...
                        priority = self.steps[current[0]][current[1]] + self.maze.steps(new_pos[0], new_pos[1])
                        self.steps[new_pos[0]][new_pos[1]] = priority
...
if __name__ == "__main__":
    app = App(MountainGenerator, DijkstrasSolver)
    app.start()
